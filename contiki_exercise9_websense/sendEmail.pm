...
my %conf = (
    ...
    "authorName"           => 'John Doe',                     	   ## Author's Name
    "authorEmail"          => 'hurni@iam.unibe.ch',                ## Author's Email Address
    "timezone"             => '+0000',                             ## We always use +0000 for the time zone
    "hostname"             => 'asterix.unibe.ch',                  ## Used in printmsg() for all output (is updated later in the script).
    ...
    ## Network
    "server"               => 'asterix.unibe.ch',                  ## Default SMTP server
